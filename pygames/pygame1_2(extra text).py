...
# character_walk_1 = pygame.image.load('pygames/graphics/char/Jump2.png').convert_alpha()
# character_walk_2 = pygame.image.load('pygames/graphics/char/Fall2.png').convert_alpha()
# character_walk = [character_walk_1, character_walk_2]
# character_index = 0
# character_jump = pygame.image.load('pygames/graphics/char/Jump2.png').convert_alpha()
# character_fall = pygame.image.load('pygames/graphics/char/Fall2.png').convert_alpha()
...
# character2_walk_1 = pygame.image.load('pygames/graphics/char/Jump3.png').convert_alpha()
# character2_walk_1 = pygame.transform.scale(character2_walk_1, (90, 90))
# character2_walk_2 = pygame.image.load('pygames/graphics/char/Fall3.png').convert_alpha()
# character2_walk_2 = pygame.transform.scale(character2_walk_2, (90, 90))
# character2_walk = [character2_walk_1, character2_walk_2]
# character2_index = 0
# character2_jump = pygame.image.load('pygames/graphics/char/Jump3.png').convert_alpha()
# character2_fall = pygame.image.load('pygames/graphics/char/Fall3.png').convert_alpha()
